...
const TARGET_CONFIG: Record<string, RelationTargetConfig> = {
  ...
  deal: { table: "deals", selectFields: "id, name", nameField: "name" },
  person: { table: "users", selectFields: "id, name, email", nameField: "name" },
  team_member: { table: "users", selectFields: "id, name, email", nameField: "name" },
  campaign: { table: "campaigns", selectFields: "id, title", nameField: "title" },
  catalog_item: { table: "catalog_items", selectFields: "id, name", nameField: "name" },
