...
export const TASK_TYPES = [
  { id: "website_visit", name: "Website Visit", icon: "Eye", emoji: "🌐" },
  { id: "demo", name: "Product Demo", icon: "PlayCircle", emoji: "🎮" },
  { id: "meeting", name: "Meeting", icon: "Users", emoji: "👥" },
  { id: "email", name: "Email", icon: "Mail", emoji: "📧" },
  { id: "call", name: "Call", icon: "Phone", emoji: "📞" },
  { id: "quote", name: "Quote", icon: "FileText", emoji: "💰" },
  { id: "contract", name: "Contract", icon: "FileText", emoji: "📝" },
  { id: "payment", name: "Payment", icon: "Tag", emoji: "💳" },
  { id: "referral", name: "Referral", icon: "User", emoji: "🤝" },
  { id: "feedback", name: "Feedback", icon: "MessageSquare", emoji: "💭" },
  { id: "trial", name: "Trial", icon: "PlayCircle", emoji: "🔬" },
  { id: "onboarding", name: "Onboarding", icon: "BookOpen", emoji: "🚀" },
  { id: "refund", name: "Refund", icon: "RotateCcw", emoji: "💸" },
  { id: "ticket", name: "Support Ticket", icon: "HelpCircle", emoji: "🎫" },
  { id: "kyc", name: "KYC/Verification", icon: "Shield", emoji: "🔐" },
  { id: "training", name: "Training", icon: "GraduationCap", emoji: "🎓" },
  { id: "consultation", name: "Consultation", icon: "UserCheck", emoji: "👨‍💼" },
  { id: "follow_up", name: "Follow Up", icon: "Clock", emoji: "🔄" },
  { id: "survey", name: "Survey", icon: "FileQuestion", emoji: "📊" },
  { id: "review", name: "Review", icon: "Star", emoji: "⭐" },
  { id: "support", name: "Support", icon: "Headphones", emoji: "🆘" },
  { id: "billing", name: "Billing", icon: "CreditCard", emoji: "🧾" },
  { id: "documentation", name: "Documentation", icon: "FileText", emoji: "📚" },
  { id: "integration", name: "Integration", icon: "Zap", emoji: "🔗" }
]
