...
function UseCaseGridContent() {
  ...
  const categoryDetails: Record<string, { title: string, description: string }> = {
    "All": {
      title: "All Models & Industries",
      description: "Explore how Makinari adapts to any business model, providing AI-driven solutions to multiply your operational capacity and scale your go-to-market strategy."
    },
    "Solopreneurs": {
      title: "Solopreneurs",
      description: "Multiply yourself. Automate your prospecting, client qualification, and follow-ups so you can focus on delivering value instead of chasing leads."
    },
    "SMBs": {
      title: "Small & Medium Businesses",
      description: "Build a scalable sales and support engine without the overhead of hiring large commercial teams. Makinari agents work 24/7 to keep your pipeline full."
    },
    "Startups": {
      title: "Startups",
      description: "Find Product-Market Fit faster. Rapidly test different messaging, target audiences, and outbound strategies to acquire your first users and scale efficiently."
    },
    "Scale Ups": {
      title: "Scale Ups",
      description: "Pour fuel on the fire. Automate complex sales sequences, standardize your outreach, and handle massive lead volumes as you expand into new markets."
    },
    "Enterprise": {
      title: "Enterprise Solutions",
      description: "Deploy robust, secure, and compliant AI agents across multiple departments. Streamline operations, reduce CAC at scale, and enhance customer experience."
    },
    "B2B": {
      title: "B2B Go-To-Market",
      description: "Master complex sales cycles. Use Makinari to identify key decision-makers, personalize your cold outreach, and nurture high-value accounts automatically."
    },
    "B2C": {
      title: "B2C Go-To-Market",
      description: "Engage thousands of users instantly. Automate onboarding, handle customer support inquiries, and drive conversion rates with personalized AI interactions."
    },
    "B2B2B": {
      title: "B2B2B Models",
      description: "Manage multi-tiered distribution channels. Empower your partners and distributors with AI agents that help them sell your products more effectively."
    },
    "B2B2C": {
      title: "B2B2C Models",
      description: "Bridge the gap between businesses and end consumers. Automate interactions across the entire value chain, from partner acquisition to consumer support."
    }
  }
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
        <div>
          ...
          <p className="dark:text-white/50 text-slate-500 text-lg max-w-xl">
            See exactly how Makinari can transform your unique go-to-market strategy.
          </p>
        </div>
        ...
        <div className="flex-1 flex flex-col min-w-0">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="text-sm md:text-base dark:text-slate-400 text-slate-600 leading-relaxed max-w-2xl">
                    {categoryDetails[activeCategory]?.description || "Explore use cases for this category."}
                  </p>
                </motion.div>
              </AnimatePresence>
            </div>
          ...
          {filteredUseCases.length > 0 ? (
            ...
            <div className="w-full py-20 flex flex-col items-center justify-center text-center border border-dashed dark:border-white/10 border-black/10 rounded-2xl">
              ...
              <h3 className="text-lg font-bold dark:text-white text-slate-900 mb-2">No use cases found</h3>
              <p className="dark:text-slate-400 text-slate-500 max-w-sm">
                We couldn't find any use cases matching "{searchQuery}". Try adjusting your filters or search term.
              </p>
            </div>
          )}
        </div>
