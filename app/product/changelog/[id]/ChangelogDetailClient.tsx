    ...
    <div className="relative w-full dark:bg-[#030303] bg-white dark:text-white text-slate-900 selection:bg-indigo-500/30 flex flex-col overflow-hidden min-h-screen">
      ...
      <section className="pt-24 pb-12 max-w-4xl mx-auto px-6 lg:px-12 flex-1 w-full relative z-10">
        <Link href="/product/changelog" className="inline-flex items-center text-sm font-bold text-slate-500 hover:text-indigo-500 transition-colors mb-8 group">
          ...
          {t('changelog.backToList') || 'Back to Changelog'}
        </Link>
        
        <div className="bg-[#f0f4f8] dark:bg-[#0f0f13] rounded-[2rem] p-8 md:p-12 shadow-sm border border-transparent dark:border-white/10">
          
          <div className="inline-flex items-center rounded-full bg-slate-200/50 dark:bg-white/5 px-4 py-1.5 text-xs font-bold mb-6 text-slate-600 dark:text-white/70 uppercase tracking-widest">
            {t('changelog.release') || 'Release'} {release.version} • {release.date}
          </div>
          
          <h1 className="text-4xl md:text-[44px] font-extrabold tracking-tight mb-8 leading-tight text-slate-900 dark:text-white">
            {release.title}
          </h1>
          
          <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-6">
            {t('changelog.overview') || 'Overview'}
          </h2>
          ...
          <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-6">
            {t('changelog.keyChanges') || 'Key Changes'}
          </h2>
          ...
          <h2 className="text-2xl font-bold dark:text-white text-slate-900 mb-6">
            {t('changelog.developerNotes') || 'Developer Notes'}
          </h2>
