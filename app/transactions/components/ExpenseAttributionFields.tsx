...
export function ExpenseAttributionFields({
  ...
  return (
    <>
      <div className="text-xs font-semibold text-muted-foreground mt-2 border-b pb-1">
        {t('expenses.field.attribution') || "Attribution (optional)"}
      </div>

      <div className="grid grid-cols-4 items-center gap-4">
        <Label className="text-right">{t('expenses.field.client') || "Client"}</Label>
      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <Label className="text-right">{t('expenses.field.catalogItem') || "Product / Service"}</Label>
        <div className="col-span-3">
          <RelationSelect
      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <Label className="text-right">{t('expenses.field.catalogCategory') || "Item Category"}</Label>
        <div className="col-span-3">
          <RelationSelect
      ...
      <div className="grid grid-cols-4 items-center gap-4">
        <Label className="text-right">{t('expenses.field.campaign') || "Campaign"}</Label>
        <div className="col-span-3">
          <RelationSelect
      ...
      {(locations.length > 1 || formData.locationValue) && (
        <div className="grid grid-cols-4 items-center gap-4">
          <Label className="text-right">{t('expenses.field.location') || "Location"}</Label>
          <div className="col-span-3">
            <RelationSelect
