...
const squadMakinariActivities = {
  gear: [
    {
      id: "sq_gear_1",
      name: "Requirements Orchestration",
      description: "Orchestrate requirements, assign tasks, perform final QA and prevent budget spending without authorization.",
  ...
  pixel: [
    {
      ...
      description: "Development in React, Next.js, UI/UX implementation and Tailwind CSS.",
      status: "available" as const
    }
  ],
  vibe: [
    {
      ...
      description: "Creation of aesthetics, branding, design assets and visual prompts generation.",
      status: "available" as const
    }
  ],
  script: [
    {
      ...
      description: "Persuasive writing, sales emails and SEO-optimized content generation.",
      status: "available" as const
    }
  ],
  ledger: [
    {
      ...
      description: "Development of pricing models, CAC/LTV analysis and SaaS financial management.",
      status: "available" as const
    }
  ],
  root: [
    {
      ...
      description: "Infrastructure management, Docker deployments and automation scripts creation.",
      status: "available" as const
    }
  ],
  vector: [
    {
      id: "sq_vc_1",
      name: "Data & Growth Analysis",
      description: "Advanced SQL analysis, user segmentation and conversion metrics optimization.",
      status: "available" as const
    }
  ],
  glitch: [
    {
      ...
      description: "Intensive bug hunting, flow stress testing and deliverable validation before handoff.",
      status: "available" as const
    }
  ],
  recon: [
    {
      id: "sq_rc_1",
      name: "Market Intelligence & OSINT",
      description: "Intensive web searches, competitor analysis and open-source intelligence gathering.",
      status: "available" as const
    }
  ]
};
...
export const agents: Agent[] = [
  {
    id: "mkn1",
    name: "Gear (Main)",
    role: "Autonomous PM & Gatekeeper",
    description: "Orchestrate requirements, assign tasks, final QA and budget protection.",
    type: "management",
    status: "active",
    conversations: 120,
    successRate: 99,
    ...
    icon: "Shield",
    activities: squadMakinariActivities.gear
  },
  {
    id: "mkn2",
    name: "Pixel",
    role: "Lead Frontend Architect",
    description: "React, Next.js, UI/UX code, Tailwind.",
    type: "product",
    status: "active",
    conversations: 85,
    successRate: 98,
    lastActive: new Date().toISOString(),
    icon: "LayoutGrid",
    activities: squadMakinariActivities.pixel
  },
  {
    id: "mkn3",
    name: "Vibe",
    role: "Head of Design",
    description: "Aesthetics, branding, design assets and visual prompts.",
    type: "product",
    status: "active",
    conversations: 64,
    successRate: 97,
    lastActive: new Date().toISOString(),
    icon: "Palette",
    activities: squadMakinariActivities.vibe
  },
  {
    id: "mkn4",
    name: "Script",
    role: "Head of Copy & Brand Voice",
    description: "Persuasive texts, sales emails, SEO content.",
    type: "marketing",
    status: "active",
    conversations: 142,
    successRate: 96,
    lastActive: new Date().toISOString(),
    icon: "Edit",
    activities: squadMakinariActivities.script
  },
  {
    id: "mkn5",
    name: "Ledger",
    role: "Virtual CFO",
    description: "Pricing models, CAC/LTV analysis, SaaS finance.",
    type: "management",
    status: "active",
    conversations: 45,
    successRate: 100,
    lastActive: new Date().toISOString(),
    icon: "DollarSign",
    activities: squadMakinariActivities.ledger
  },
  {
    id: "mkn6",
    name: "Root",
    role: "Lead DevOps & SRE",
    description: "Infrastructure, Docker, automation scripts.",
    type: "management",
    status: "active",
    conversations: 112,
    successRate: 99,
    lastActive: new Date().toISOString(),
    icon: "Settings",
    activities: squadMakinariActivities.root
  },
  {
    id: "mkn7",
    name: "Vector",
    role: "Head of Growth & Data",
    description: "SQL analysis, segmentation, conversion metrics.",
    type: "marketing",
    status: "active",
    conversations: 93,
    successRate: 98,
    lastActive: new Date().toISOString(),
    icon: "PieChart",
    activities: squadMakinariActivities.vector
  },
  {
    id: "mkn8",
    name: "Glitch",
    role: "Lead QA Tester",
    description: "Find bugs, break flows, validate deliverables.",
    type: "product",
    status: "active",
    conversations: 156,
    successRate: 97,
    lastActive: new Date().toISOString(),
    icon: "AlertTriangle",
    activities: squadMakinariActivities.glitch
  },
  {
    id: "mkn9",
    name: "Recon",
    role: "Head of Market Intelligence",
    description: "Intensive web search, competitor analysis, OSINT.",
    type: "sales",
    status: "active",
    conversations: 201,
    successRate: 95,
    lastActive: new Date().toISOString(),
    icon: "Globe",
    activities: squadMakinariActivities.recon
  },
  {
    id: "1",
