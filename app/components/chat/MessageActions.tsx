          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full font-sans transition-colors hover:bg-white dark:hover:bg-white/10"
                type="button"
                style={{
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                disabled={isDeleting}
                className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full font-sans transition-colors hover:bg-white dark:hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed"
                type="button"
                style={{
                  color: isDarkMode ? 'rgba(156, 163, 175, 0.9)' : 'rgba(107, 114, 128, 0.9)'
                }}
