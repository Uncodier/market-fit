          ...
          {allCards.map((card, i) => {
            ...
            return (
              <button
                ...
                className={`flex-shrink-0 inline-flex items-center gap-2 px-3 py-2 rounded-xl border transition-colors duration-150 text-left group ${
                  isSelected
              ...
              >
                <span
                  className={`inline-flex size-4 flex-shrink-0 items-center justify-center [&_svg]:block ${card.color}`}
                  aria-hidden={true}
                >
                  {card.icon}
                </span>
                <span
                  className={`text-xs leading-none whitespace-nowrap transition-colors duration-150 ${
