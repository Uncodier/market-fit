                ...
                {steps.map((step, index) => {
                  ...
                  return (
                    <div 
                      ...
                      title={canEdit ? "Click to edit step" : "Completed step"}
                    >
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <Button
                          ...
                          className={`h-6 w-6 p-0 hover:bg-green-100 dark:hover:bg-green-900/30 transition-opacity ${
                            isCompleted ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
                          }`}
                          title={isCompleted ? "Mark as pending" : "Mark as completed"}
                        >
                          <CheckCircle className={`h-3 w-3 ${isCompleted ? 'text-green-500' : 'text-muted-foreground'}`} />
                        </Button>
