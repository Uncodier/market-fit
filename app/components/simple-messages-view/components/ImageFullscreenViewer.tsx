  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-[95vw] max-h-[95vh] w-[95vw] h-[95vh] p-0 gap-0 flex flex-row overflow-hidden sm:rounded-lg">
        ...
        <div className="w-[400px] border-l dark:border-white/5 border-black/5 bg-card overflow-y-auto flex flex-col">
          <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              {/* Image URL */}
              <div>
                <h4 className="text-sm font-semibold mb-2">URL de la Imagen</h4>
              ...
              {/* Image info */}
              <div>
                <h4 className="text-sm font-semibold mb-2">Información de la Imagen</h4>
