    ...
    <div className="flex flex-col w-full min-w-0 items-start group">
      <div className="flex items-center mb-1 gap-2 w-full min-w-0">
        <div className="relative">
          <div className="h-7 w-7 border border-primary/20 rounded-full bg-primary/10 text-primary flex items-center justify-center text-xs font-medium">
            A
          </div>
        </div>
      ...
      <div className="mr-8 w-full min-w-0 overflow-hidden">
        <div className="relative rounded-xl p-4 border border-primary/15 bg-background/60 backdrop-blur-sm overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-violet-500/8 rounded-full blur-2xl animate-[float-slow_20s_ease-in-out_infinite]" />
            <div className="absolute top-0 left-1/4 w-20 h-20 bg-indigo-500/10 rounded-full blur-xl animate-[float-medium_18s_ease-in-out_infinite]" style={{ animationDelay: '3s' }} />
            <div className="absolute bottom-0 right-1/4 w-24 h-24 bg-purple-500/8 rounded-full blur-xl animate-[float-reverse_22s_ease-in-out_infinite]" style={{ animationDelay: '6s' }} />
            <div className="absolute top-1/3 right-8 w-16 h-16 bg-pink-500/10 rounded-full blur-xl animate-[float-fast_16s_ease-in-out_infinite]" style={{ animationDelay: '1s' }} />
          </div>
