...
export function PassBookingPanel({
  ...
  return (
    <div className="space-y-6">
      {hasNoAccess && (
        <div className="overflow-hidden rounded-3xl border border-destructive/20 bg-destructive/5 relative p-6 sm:p-8 flex items-center gap-6">
      ...
      {selectedService ? (
        <div className={hasNoAccess ? "opacity-50 pointer-events-none" : ""}>
          <BookingExperience
            mode="entitlement"
