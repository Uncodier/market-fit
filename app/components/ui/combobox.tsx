  ...
  return (
    <div className="space-y-2">
      ...
      <Popover open={open} onOpenChange={setOpen}>
          ...
          <div className="relative w-full">
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center">
              {clearable && value && (
                <button
                  type="button"
                  className="h-3.5 w-3.5 mr-1 rounded-full font-inter text-muted-foreground hover:text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-ring"
                  onClick={handleClear}
        ...
        <PopoverContent className="p-0 w-[var(--radix-popover-trigger-width)] max-h-[300px] font-inter" align="start">
          <div className="p-2">
