        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 flex flex-col items-center text-center">
          <Reveal delay={0}>
            <div className="inline-flex items-center rounded-full font-inter dark:neu-black-chip neu-white-chip px-4 py-1.5 text-sm font-bold mb-8 transition-transform hover:scale-105 duration-300">
              <span className="flex h-2 w-2 rounded-full font-inter font-bold bg-violet-500 mr-2 animate-pulse shadow-[0_0_8px_rgba(139,92,246,0.8)]"></span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:[grid-template-rows:700px] auto-rows-[minmax(450px,auto)]">
            ...
            <Reveal delay={100} className="lg:col-span-2 h-full">
              <Link href="/product/outbound" className="w-full h-full rounded-xl dark:neu-base neu-base-light overflow-hidden relative group p-8 md:p-12 flex flex-col justify-between transition-all duration-500 hover:-translate-y-2 hover:-translate-x-2 block">
                ...
                <div className="absolute right-[-100px] bottom-[-100px] w-[500px] h-[500px] pointer-events-none opacity-40 dark:mix-blend-screen mix-blend-multiply transition-opacity duration-500 group-hover:opacity-60 [mask-image:radial-gradient(circle_at_center,black_30%,transparent_70%)]">
                  ...
                  <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] border border-orange-500/30 rounded-full font-inter animate-radar-ping"></div>
                ...
                <div className="absolute hidden md:block right-[5%] top-[15%] w-56 rounded-lg border dark:border-white/[0.08] border-black/10 dark:bg-[#121214]/90 bg-white/90 backdrop-blur-2xl p-5 shadow-2xl animate-float-medium transition-transform group-hover:scale-105 group-hover:-translate-y-2 group-hover:rotate-1 font-inter z-20">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="w-1.5 h-1.5 rounded-full font-inter font-bold bg-green-500 animate-pulse shadow-[0_0_8px_rgba(34,197,94,0.8)]"></div>
                  </div>
                  <div className="space-y-3">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-3">
                        <div className={`w-6 h-6 rounded-full font-inter flex items-center justify-center ${item.color}`}>
                          {item.icon}
                        </div>
                ...
                <div className="absolute right-0 bottom-0 w-full h-[300px] pointer-events-none">
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute right-[5%] bottom-[10%] w-60 rounded-lg border dark:border-white/[0.08] border-black/10 dark:bg-[#121214]/90 bg-white/90 backdrop-blur-2xl p-6 shadow-2xl animate-float-slow transition-transform group-hover:scale-105 group-hover:-translate-y-2 group-hover:-rotate-2 font-inter z-30">
                      ...
                      <div className="h-1.5 w-full dark:bg-white/5 bg-black/5 rounded-full font-inter overflow-hidden relative">
                        <div className="absolute inset-y-0 left-0 bg-gradient-to-r from-orange-500 to-rose-500 w-[99.8%] rounded-full font-inter shadow-[0_0_10px_rgba(244,63,94,0.5)]"></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Link href="/product/inbound" className="w-full h-full rounded-xl dark:neu-base neu-base-light overflow-hidden relative group p-8 flex flex-col items-center text-center justify-between transition-all duration-500 hover:-translate-y-2 hover:-translate-x-2 block">
                ...
                <div className="relative w-full h-48 mt-8 flex items-center justify-center pointer-events-none">
                  ...
                  <div className="absolute inset-0 animate-spin-super-slow flex items-center justify-center pointer-events-none">
                    <div className="absolute w-[160px] h-[160px] rounded-full font-inter border dark:border-white/[0.05] border-black/10"></div>
                    <div className="absolute w-[240px] h-[240px] rounded-full font-inter border dark:border-white/[0.03] border-black/5"></div>
                    
                    {/* Node: Email */}
                    <div className="absolute -top-3 w-10 h-10 rounded-full font-inter dark:bg-[#121214] bg-white border dark:border-white/10 border-black/10 shadow-[0_0_15px_rgba(59,130,246,0.3)] flex items-center justify-center animate-[spin_40s_linear_infinite_reverse]">
                    ...
                    {/* Node: WhatsApp */}
                    <div className="absolute top-[15%] -right-2 w-10 h-10 rounded-full font-inter dark:bg-[#121214] bg-white border dark:border-white/10 border-black/10 shadow-[0_0_15px_rgba(34,197,94,0.3)] flex items-center justify-center animate-[spin_40s_linear_infinite_reverse]">
                    ...
                    {/* Node: LinkedIn */}
                    <div className="absolute -bottom-1 right-[25%] w-10 h-10 rounded-full font-inter dark:bg-[#121214] bg-white border dark:border-white/10 border-black/10 shadow-[0_0_15px_rgba(0,119,181,0.3)] flex items-center justify-center animate-[spin_40s_linear_infinite_reverse]">
                    ...
                    {/* Node: SMS */}
                    <div className="absolute bottom-[20%] -left-1 w-10 h-10 rounded-full font-inter dark:bg-[#121214] bg-white border dark:border-white/10 border-black/10 shadow-[0_0_15px_rgba(168,85,247,0.3)] flex items-center justify-center animate-[spin_40s_linear_infinite_reverse]">
            ...
            <Reveal delay={300} className="lg:col-span-1 h-full">
              <Link href="/product/agents" className="w-full h-full rounded-xl dark:neu-base neu-base-light overflow-hidden relative group p-8 flex flex-col justify-between transition-all duration-500 hover:-translate-y-2 hover:-translate-x-2 block">
                ...
                <div className="relative z-10">
                  <div className="inline-flex items-center rounded-full font-inter dark:neu-black-chip-inward neu-white-chip-inward px-3 py-1 text-xs font-mono font-bold mb-6">
                    ~/developer-first
                  </div>
                ...
                <div className="relative z-10 mt-8 rounded-md border dark:border-white/10 border-black/10 dark:bg-[#09090b] bg-white shadow-2xl overflow-hidden group-hover:-translate-y-2 transition-transform duration-500">
                  <div className="flex items-center px-4 py-2 border-b dark:border-white/5 border-black/5 bg-black/40">
                    <div className="flex gap-1.5">
                      <div className="w-2.5 h-2.5 rounded-full font-inter font-bold bg-[#ff5f56]"></div>
                      <div className="w-2.5 h-2.5 rounded-full font-inter font-bold bg-[#ffbd2e]"></div>
                      <div className="w-2.5 h-2.5 rounded-full font-inter font-bold bg-[#27c93f]"></div>
                    </div>
                  </div>
            ...
            <Reveal delay={400} className="lg:col-span-2 h-full">
              <Link href="/product/cms" className="w-full h-full rounded-xl dark:neu-base neu-base-light overflow-hidden relative group p-8 md:p-12 flex flex-col md:flex-row gap-8 justify-between transition-all duration-500 hover:-translate-y-2 hover:-translate-x-2 block">
                ...
                <div className="relative z-10 max-w-sm flex flex-col justify-center">
                  <div className="inline-flex items-center rounded-full font-inter dark:neu-black-chip-inward neu-white-chip-inward px-3 py-1 text-xs font-bold mb-6 self-start">
