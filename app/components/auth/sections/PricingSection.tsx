      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          <div className="inline-flex items-center rounded-full font-sans dark:neu-black-chip neu-white-chip px-3 py-1 text-xs font-bold mb-6">
            <span className="w-1.5 h-1.5 rounded-full font-sans font-bold bg-violet-500 mr-2 shadow-[0_0_8px_rgba(139,92,246,0.8)]"></span>
            ...
            >
              ...
              {isPopular && (
                <>
                  ...
                  <div className="absolute top-6 right-6 inline-flex items-center rounded-full font-sans font-bold bg-violet-500/20 dark:bg-violet-500/20 border border-violet-500/30 dark:border-violet-500/30 px-3 py-1 text-[10px] font-bold tracking-widest uppercase text-violet-700 dark:text-violet-300 shadow-[0_0_15px_rgba(139,92,246,0.3)] z-20 backdrop-blur-md">
                    <span className="w-1.5 h-1.5 rounded-full font-sans font-bold bg-violet-600 dark:bg-violet-400 mr-2 animate-pulse shadow-[0_0_8px_rgba(167,139,250,0.8)]"></span>
                ...
                <ul className="space-y-4 mb-8 flex-1">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-start gap-3 dark:text-white/80 text-slate-500 text-sm">
                      <div className="mt-0.5 flex-shrink-0 w-5 h-5 rounded-full font-sans font-bold bg-violet-500/20 flex items-center justify-center">
                ...
                <div className="mt-auto pt-6 border-t dark:border-white/[0.06] border-black/5">
                  ...
                  {plan.ctaExternal ? (
                    <a
                      ...
                      className={`block w-full py-3.5 px-6 rounded-md text-center font-bold font-sans transition-all duration-300 active:scale-[0.98] ${
                        isPopular 
        ...
        {showFullPricingButton && (
          <div className="mt-16 text-center flex justify-center">
            <Link
              ...
              className="inline-flex items-center text-sm font-bold text-violet-500 hover:text-violet-600 dark:text-violet-400 dark:hover:text-violet-300 transition-colors group"
            >
