              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2.5">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full font-inter font-bold bg-green-500"></div>
                  ...
                  {session.last_used_at && (
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 rounded-full font-inter font-bold bg-blue-500"></div>
                      <div className="flex-1 flex items-center justify-between">
                  ...
                  {session.expires_at && (
                    <div className="flex items-center gap-3">
                      <div className="w-2 h-2 rounded-full font-inter font-bold bg-orange-500"></div>
                      <div className="flex-1 flex items-center justify-between">
