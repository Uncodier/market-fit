...
export function ShopCategoryChips({
  ...
  const chipClass = (active: boolean) =>
    `flex-shrink-0 px-5 h-10 flex items-center justify-center rounded-full text-sm font-medium transition-all duration-200 border backdrop-blur-3xl shadow-sm leading-normal whitespace-nowrap ${
      active
  ...
  return (
    <div className="sticky top-[72px] z-30 pointer-events-none -mx-4 pt-2 pb-4 mb-6">
      <div
        ref={scrollerRef}
        className="flex overflow-x-auto gap-3 scrollbar-hide w-full items-center pointer-events-auto py-3 px-4"
      >
        {leadingChip}
        {categories.length > 0 && (
          <button
